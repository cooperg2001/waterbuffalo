...
public class Archon {
    ...
    static void runArchon(RobotController rc) throws GameActionException {
		...
		if(numArchon == 0){
            ...
            rc.broadcast(37, 0); // Turtle alert
		}
        ...
        while(true){
            try{
                ...
                for(int i = 0; i < RobotPlayer.num_angles; i++){
                    ...
                    if(rc.canHireGardener(dir) && (((rc.readBroadcast(904) + rc.readBroadcast(903) + 1 > 5 * rc.readBroadcast(901)) && (rc.getTreeCount() + 1 > 3 * rc.readBroadcast(901))) || rc.getTeamBullets() > 310)){
