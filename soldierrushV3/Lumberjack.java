...
public class Lumberjack {
    ...
    static void runLumberjack(RobotController rc) throws GameActionException {
         ...
         * 1 - Chasing enemies
         * 2 - Retreating
         * 3 - super aggro: for late game or turtles
         */
        ...
        while(true){
            try{
                ...
                RobotInfo[] our_robots = rc.senseNearbyRobots(-1, RobotPlayer.FRIEND);
                ...
                // If there's a turtle alert or roundnum > 2000, set to be super aggro
                if (rc.readBroadcast(37) == 1 || rc.getRoundNum() > 2000){
                    status = 3;
                }
                ...
                // CHASE MODE
                    ...
                    if (their_robots.length > 0){
                        ...
                        // If adjacent to an enemy but not an ally, strike
                ...
                // CHOP TREES MODE
                    ...
                    // TURTLE MODE or LATE GAME AGGRO MODE
