            ...
            try{
                ...
                for(int i = 0; i < RobotPlayer.num_angles; i++){
                    ...
                    if(rc.canHireGardener(dir)
                            && (
                                (
                                    (soldier_ct + lumberjack_ct + tank_ct >= RobotPlayer.getArmyToGardenerRatio() * gardener_ct) && (tree_ct >= RobotPlayer.getTreeToGardenerRatio() * gardener_ct)
                                    || rc.getTeamBullets() > 150
                                    || round_tree_was_planted_last + 200 < round_num
                                )
                               )
                        ){
